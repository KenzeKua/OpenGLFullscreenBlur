...
int Init ( void )
{
   ...
   // Create a second empty texture for rendering blur
...
{	
    ...
    if (status == GL_FRAMEBUFFER_COMPLETE)
    {
        ...
        glUniform1i(glGetUniformLocation(GprogramID, "uBlurDirection"), 0); // Set horizontal blur
    ...
    glUniform1i(glGetUniformLocation(GprogramID, "uBlurDirection"), 1); // Set vertical blur
